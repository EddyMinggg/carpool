...
class AdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super-admin.admins.index', compact('admins', 'isMobile'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('super-admin.admins.create', compact('isMobile'));
    }
    ...
    public function show(Request $request, User $admin)
    {
        ...
        return view('super-admin.admins.show', compact('admin', 'isMobile'));
    }
    ...
    public function edit(Request $request, User $admin)
    {
        ...
        return view('super-admin.admins.edit', compact('admin', 'isMobile'));
    }
