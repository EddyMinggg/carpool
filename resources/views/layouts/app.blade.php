...
<body class="font-sans">
    <div class="min-h-screen pb-20 bg-gray-100 dark:bg-secondary-dark">
        @include('layouts.navigation')

        <!-- Page Heading -->
        @isset($header)
            <header class="bg-secondary dark:bg-secondary-accent shadow">
        ...
        @if (!session('guest_mode') && !request()->routeIs('about.*'))
