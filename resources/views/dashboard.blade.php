            ...
            <form action="" method="post">
                <div class="md:flex gap-4">
                    <div class="w-full">
                        ...
                        <x-text-input id="pickup" class="block mt-1 w-full" type="text" name="pickup" :value="old('pickup')" required />
                        <x-input-error :messages="$errors->get('pickup')" class="mt-2" />
                    </div>

                    <div class="w-full">
                        <x-input-label for="dropoff" :value="__('Dropoff Location')" />
                        <x-text-input id="dropoff" class="block mt-1 w-full" type="text" name="dropoff" :value="old('dropoff')" required />
                    ...
                    <div class="w-full flex pt-6">
                        <x-primary-button class="w-full" style="display: block !important">
                            {{ __('Check Price') }}
                        </x-primary-button>
                    </div>
                </div>
