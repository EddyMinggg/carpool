<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div class="bg-secondary dark:bg-secondary-accent rounded-2xl shadow-xl p-8 md:p-12">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Privacy Policy') }}</h1>
            ...
            <div class="prose prose-lg max-w-none dark:text-gray-300">
                <!-- Who We Are -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Who We Are') }}</h2>
                ...
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Information We Collect') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <!-- Cookies -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Cookies') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <!-- Google Analytics -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Google Analytics') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('How We Use Your Information') }}</h2>
                ...
                <!-- Website Comments -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Website Comments') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('WhatsApp Communication') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <!-- Third Parties -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Third Parties') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <!-- Data Protection -->
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Data Protection') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Access to Your Personal Information') }}</h2>
                ...
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">{{ __('Changes to Our Privacy Policy') }}</h2>
                <p class="text-gray-700 dark:text-gray-300 mb-4">
