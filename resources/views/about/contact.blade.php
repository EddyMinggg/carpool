    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-secondary dark:bg-secondary-accent rounded-2xl shadow-lg p-8">
                ...
                <div class="space-y-4">
                    <a href="https://wa.me/85298588879" target="_blank"
                        class="flex items-center justify-center w-full bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-lg font-semibold transition">
                    ...
                    <a href="tel:+85298588879"
                        class="flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg font-semibold transition">
                    ...
                    <a href="mailto:danielwu@snowpins.com"
                        class="flex items-center justify-center w-full bg-purple-600 hover:bg-purple-700 text-white py-3 px-6 rounded-lg font-semibold transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        {{ __('Send Email') }}
                ...
                <p class="mt-6 text-sm text-gray-500 dark:text-gray-500 text-center">
