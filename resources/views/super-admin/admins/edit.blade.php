        ...
        <div class="mobile-container">
            <div class="mobile-form-container">
                <form action="{{ route('super-admin.admins.update', $admin->id) }}" method="POST">
                    ...
                    <!-- Password (optional) -->
                    <div style="margin-bottom: 16px;">
                        <label for="mobile-password" style="display: block; font-weight: 600; color: #374151; margin-bottom: 6px;">New Password <span style="font-weight: normal; color: #6b7280;">(leave blank to keep current)</span></label>
                    ...
                    <div style="margin-bottom: 24px;">
                        <label for="mobile-password-confirmation" style="display: block; font-weight: 600; color: #374151; margin-bottom: 6px;">Confirm New Password</label>
