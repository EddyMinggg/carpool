<x-app-layout>
            ...
            <div class="mt-3 text-center">
                ...
                <div class="items-center px-4 py-3 flex gap-2 justify-center">
                    <button id="modalConfirmBtn"
                        class="px-4 py-2 bg-blue-600 text-white text-base font-medium rounded-md w-auto hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
                    </button>
                    <button id="modalCancelBtn"
                        class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200 text-base font-medium rounded-md w-auto hover:bg-gray-400 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-300">
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        function showConfirmModal(options) {
            ...
            // Set content
            title.innerHTML = options.title || 'Confirm Action';
