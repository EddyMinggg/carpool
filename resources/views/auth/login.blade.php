            ...
            <div id="tab3-group4" class="tab-content {{ $errors->any() && (old('username') || old('email') || old('phone')) ? 'block' : 'hidden' }} font-medium text-sm text-gray-700 dark:text-gray-300">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-center space-x-4">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-sm font-medium text-indigo-600 dark:text-indigo-400">{{ __('Basic Info') }}</span>
                        </div>
                        <div class="w-12 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                        <div class="flex items-center">
                            <div id="step2-indicator" class="w-8 h-8 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-400 flex items-center justify-center text-sm font-medium">2</div>
                            <span class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Verify Phone') }}</span>
                        </div>
                        <div class="w-12 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                        <div class="flex items-center">
                            <div id="step3-indicator" class="w-8 h-8 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-400 flex items-center justify-center text-sm font-medium">3</div>
                            <span class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Complete') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="register-step-1" class="register-step block">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <button type="button" id="send-otp-btn" class="inline-flex items-center px-4 py-2 bg-indigo-600 dark:bg-indigo-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 dark:hover:bg-indigo-600 focus:bg-indigo-500 dark:focus:bg-indigo-600 active:bg-indigo-900 dark:active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 disabled:opacity-50">
                                <span class="send-otp-text">{{ __('Send Verification Code') }}</span>
                                <svg class="send-otp-spinner animate-spin -mr-1 ml-3 h-4 w-4 text-white hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <div id="register-step-2" class="register-step hidden">
                    <form id="otp-verification-form">
                        ...
                        <div class="text-center mb-6">
                            ...
                            <h3 class="mt-3 text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Verify Your Phone Number') }}</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                {{ __('We sent a 6-digit verification code to') }}
                                <br><strong id="verification-phone" class="text-indigo-600 dark:text-indigo-400"></strong>
                            </p>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex justify-center space-x-2 mt-2">
                                <input type="text" id="otp-1" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                                <input type="text" id="otp-2" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                                <input type="text" id="otp-3" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                                <input type="text" id="otp-4" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                                <input type="text" id="otp-5" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                                <input type="text" id="otp-6" class="otp-digit w-12 h-12 text-center text-lg font-semibold border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" maxlength="1" pattern="[0-9]">
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <button type="button" id="resend-otp-btn" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 font-medium disabled:opacity-50 disabled:cursor-not-allowed">
                                    <span class="resend-text">{{ __('Resend') }}</span>
                                    <span class="resend-countdown hidden">{{ __('Resend in') }} <span id="countdown">60</span>s</span>
                                </button>
                            </p>
                        </div>

                        <div class="flex items-center justify-between mt-6">
                            <button type="button" id="back-to-basic-btn" class="inline-flex items-center px-4 py-2 bg-gray-600 dark:bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500 dark:hover:bg-gray-600 focus:bg-gray-500 dark:focus:bg-gray-600 active:bg-gray-900 dark:active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                {{ __('Back') }}
                            </button>
                            
                            <button type="button" id="verify-otp-btn" class="inline-flex items-center px-4 py-2 bg-indigo-600 dark:bg-indigo-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 dark:hover:bg-indigo-600 focus:bg-indigo-500 dark:focus:bg-indigo-600 active:bg-indigo-900 dark:active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 disabled:opacity-50">
                                <span class="verify-otp-text">{{ __('Verify & Complete Registration') }}</span>
                                <svg class="verify-otp-spinner animate-spin -mr-1 ml-3 h-4 w-4 text-white hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                            </button>
                ...
                <div id="register-step-3" class="register-step hidden">
                    <div class="text-center">
                        ...
                        <h3 class="mt-3 text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Registration Completed!') }}</h3>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
