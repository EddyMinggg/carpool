        ...
        <form action="{{ route('admin.trips.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="creator_id" id="creator_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @foreach($users as $user)
                        <option value="{{ $user->user_id }}" {{ old('creator_id') == $user->user_id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select name="trip_status" id="trip_status" 
                    ...
                    <option value="voting" {{ old('trip_status') === 'voting' ? 'selected' : '' }}>Voting</option>
