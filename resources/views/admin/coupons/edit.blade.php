        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-3xl">
            <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="usage_limit" id="usage_limit" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('usage_limit', $coupon->usage_limit) }}">
                    @error('usage_limit')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
