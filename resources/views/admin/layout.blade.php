    ...
    <div class="flex" style="overflow-x: hidden !important; width: 100vw !important; max-width: 100vw !important;">
        ...
        <aside id="sidebar" class="sidebar bg-gray-800 text-white">
            ...
            <nav class="p-4">
                ...
                <a href="{{ route('admin.payment-confirmation.global') }}" class="text-sm block py-2 px-3 rounded mb-2 {{ request()->routeIs('admin.payment-confirmation.*') ? 'bg-green-600 text-white' : 'hover:bg-gray-700 text-gray-200' }}">
